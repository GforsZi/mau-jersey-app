...
<head>
  ...
  <style>
    * {
    ...
    /* ===== Swiper Nav Custom (Desktop only) ===== */
    .mj-nav {
    ...
    /* panah kiri */
    .swiper-button-prev.mj-nav::before {
      transform: rotate(-135deg);
      margin-left: 2px;
    }

    /* panah kanan */
    .swiper-button-next.mj-nav::before {
      transform: rotate(45deg);
      margin-right: 2px;
    }

    .fade-pop {
      animation: fadePop 380ms ease;
    }
    ...
    .accBtn[aria-expanded="true"] .accIconRight {
      transform: rotate(180deg);
    }

    /* Left icon color change */
    .leftIcon {
      transition: color 220ms ease, background 220ms ease, border-color 220ms ease;
    }

    .accBtn[aria-expanded="true"] .leftIcon {
...
<body class="bg-slate-950 text-white">
  ...
  <header class="sticky top-0 z-50 border-b border-white/5 bg-slate-950/60 backdrop-blur-xl">
    <div class="mx-auto max-w-6xl px-4 py-4 flex items-center justify-between">
      ...
      <!-- Mobile button -->
      <button id="btnMobile" type="button"
    ...
    <div
      ...
      <div class="flex items-center gap-3">
        ...
        <a href="https://www.tiktok.com/@username" target="_blank" rel="noopener"
          ...
          <svg class="h-5 w-5 text-slate-200 group-hover:text-cyan-200 transition" viewBox="0 0 24 24"
            fill="currentColor">
            <path
